export class Booking {
    ...
    AddОneInfant() {
        cy.contains('Добавить ребёнка').click()
        cy.get('[class="tourists_option v-text-3"]').eq(1).click({ force: true })
    }
    ...
    ChooseThirdFaceBayerWithTreeTourists(){
        cy.get(':nth-child(5) > .traveller-head > .buyer-box > .buyer-switcher > .buyer-switcher-point').click()  
    }
